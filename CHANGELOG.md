...
- Hiérarchie d'exceptions : `SafeRouteError`, `GraphNotLoadedError`, `RouteNotFoundError`, `CacheCorruptionError`, `UnsupportedCityError`
- Documentation mkdocs avec mkdocstrings (docstrings Google)
- Marqueur PEP 561 `py.typed`

[Unreleased]: https://github.com/Gillesto66/SafeRoute/compare/v0.1.0...HEAD
[0.1.0]: https://github.com/Gillesto66/SafeRoute/releases/tag/v0.1.0
